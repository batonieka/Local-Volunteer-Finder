...
export const OpportunityCard = ({ opportunity }: { opportunity: VolunteerOpportunity }) => {
  return (
    <Link to={`/opportunity/${opportunity.id}`} tabIndex={0} role="link" className="block">
  <article className="bg-white shadow-md p-4 rounded-lg border hover:shadow-lg transition">
